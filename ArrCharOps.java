...
public class ArrCharOps {
    ...
    public static int lastIndexOf(char[] arr, char ch) {
        // Start from the end of the array and search backwards
    ...
    */
    ...
    public static int compareTo(String str1, String str2) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (ch1 != ch2) {
                // Return -1 or 1 based on which character is smaller
                if (ch1 < ch2){
                    return -1;
                }
                else {
        ...
        // If all characters up to the shorter string's length are the same
